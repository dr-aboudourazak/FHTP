...
class TypeActeImagerie(str, Enum):
    """Cf. R-TG-019 -- restrictions de prescription selon le type d'acte
    d'imagerie lourde. Resolu en amont a partir de la nomenclature reelle
    de l'acte (le code_acte brut ne suffit pas a lui seul a distinguer un
    scanner d'un autre acte sans un referentiel de nomenclature complet,
    qui reste a construire -- cf. JOURNAL_DEV.md)."""

    SCANNER = "SCANNER"
    IRM = "IRM"


class TypeHospitalisation(str, Enum):
    """Cf. RG-H02, RG-H09 -- necessaire pour distinguer les seuils de duree
    applicables (maternite : 5 jours ; mise en observation : 3 jours)."""

    MEDECINE = "MEDECINE"
    CHIRURGIE = "CHIRURGIE"
    MATERNITE = "MATERNITE"
    MISE_EN_OBSERVATION = "MISE_EN_OBSERVATION"
    AUTRE = "AUTRE"
