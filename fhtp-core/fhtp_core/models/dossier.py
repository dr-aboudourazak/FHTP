...
class ActeRealise(BaseModel):
    ...
    # Ajoute pour RP24-21 (kinesitherapie/appareillage orthopedique exige
    # une prescription medicale). Marqueur generique plutot que specifique
    # a la kinesitherapie seule, reutilisable pour des actes similaires.
    necessite_prescription_medicale: Optional[bool] = None
...
class MedicamentPrescrit(BaseModel):
    ...
    # Ajoute pour RP24-19 (delivrance de medicaments TPC exige l'attestation
    # TPC correspondante -- pec_id generique reutilise ici pour porter la
    # reference de l'attestation TPC specifiquement).
    necessite_tpc: Optional[bool] = None
...
class Dossier(BaseModel):
    ...
    # Ajoute pour RP24-18 (demande de TPC reservee aux medecins).
    demande_tpc: Optional[bool] = None
