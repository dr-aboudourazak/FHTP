# FHTP-KNO-001 — Addendum v0.22
## Registre des risques (RSK) — au-delà de la sécurité technique

**Date :** 9 juillet 2026
**Statut :** brouillon pour validation par Dr Amadou
**À intégrer dans :** FHTP-KNO-001 v0.20, nouvelle section 12, à la suite des "Idées en attente". Tranché le 9 juillet 2026 : ce registre vit dans le Knowledge Book plutôt que dans FHTP-ARC-001, puisque la majorité des risques listés ici sont métier et projet, pas techniques — la table de failles de sécurité (F1-F9) reste, elle, dans ARC-001, qui est le bon endroit pour un risque d'architecture.
